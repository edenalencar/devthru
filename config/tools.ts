...
export const tools: Tool[] = [
    ...
    },
    {
        ...
        description: "Gerador de CNH online e gratuito! Crie números de Carteira Nacional de Habilitação válidos com categoria selecionável (A, B, AB, C, D, E) para testes de software.",
        category: "documents",
        icon: Car,
    ...
    },
    {
        ...
        description: "Gerador de Inscrição Estadual online para todos os estados brasileiros. Crie números de IE válidos com algoritmo oficial de validação para testes de sistemas fiscais.",
        category: "documents",
        icon: FileText,
    ...
    },
    {
        ...
        description: "Gerador de endereços brasileiros completos e realistas. Inclui rua, número, bairro, cidade, estado e CEP válido para testes de formulários e sistemas de cadastro.",
        category: "personal",
        icon: MapPin,
    ...
    // Ferramentas de Texto
    {
        ...
        description: "Contador de caracteres, palavras, linhas e parágrafos em tempo real. Ferramenta essencial para SEO, redes sociais e controle de limites de texto em formulários.",
        category: "text",
        icon: Type,
    ...
    },
    {
        ...
        description: "Conversor de case online e gratuito. Transforme textos para UPPERCASE, lowercase, camelCase, PascalCase, snake_case e outras formatações em um clique.",
        category: "text",
        icon: CaseSensitive,
    ...
    },
    {
        ...
        description: "Conversor de bases numéricas online. Converta números entre decimal, binário, hexadecimal e octal instantaneamente. Ferramenta essencial para programadores e estudantes.",
        category: "converters",
        icon: Calculator,
    ...
    },
    {
        ...
        description: "Conversor de moedas online com taxas de câmbio atualizadas em tempo real. Converta entre Real, Dólar, Euro, Libra e dezenas de outras moedas mundiais.",
        category: "converters",
        icon: Coins,
    ...
    // Ferramentas de Desenvolvimento
    {
        ...
        description: "Gerador e testador de Regex online. Crie, teste e valide expressões regulares com destaque em tempo real, explicações detalhadas e biblioteca de padrões prontos.",
    ...
    },
    {
        ...
        description: "Gerador de Mock Data para desenvolvedores. Crie dados JSON aleatórios e realistas (nomes, emails, endereços, telefones) para testes de APIs e protótipos.",
        category: "development",
        icon: Database,
    ...
    },
    {
        ...
        description: "Gerador de Favicon online e gratuito. Converta qualquer imagem em favicons otimizados para web (16x16, 32x32, 180x180) e baixe o pacote completo em segundos.",
        category: "image",
        icon: Image,
    ...
    },
    {
        ...
        description: "Codificador e decodificador Base64 online. Converta texto e arquivos para Base64 e vice-versa instantaneamente. Ferramenta indispensável para desenvolvedores web.",
        category: "utilities",
        icon: Binary,
    ...
    // Document Tools
    {
        ...
        description: "Gerador de contratos online. Crie documentos profissionais personalizados como contratos de serviço, NDA e termos de uso com modelos prontos para editar e baixar.",
        category: "documents",
        icon: FileText,
    ...
    },
    {
        ...
        description: "Gerador de certificados online e gratuito. Crie certificados profissionais personalizados para cursos, workshops e eventos com modelos elegantes prontos para impressão.",
        category: "documents",
        icon: Award,
    ...
    // Text/Utility Tools
    {
        ...
        description: "Validador de email online e gratuito. Verifique se um endereço de email é válido, existe e não é temporário. Detecte emails descartáveis e proteja seus formulários.",
        category: "text",
        icon: Mail,
    ...
    // Ferramentas Automotivas
    {
        ...
        description: "Gerador de placas veiculares online. Crie e converta placas de veículos nos padrões Mercosul e antigo brasileiro. Ideal para testes de sistemas de registro automotivo.",
        category: "automotive",
        icon: Car,
    ...
    // Dados Empresariais
    {
        ...
        description: "Gerador de chave de acesso NF-e online. Crie chaves de Nota Fiscal Eletrônica válidas (44 dígitos) para testes de sistemas de emissão fiscal e homologação.",
        category: "business",
        icon: Barcode,
