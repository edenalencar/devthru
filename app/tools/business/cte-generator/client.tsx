...
export function CteGeneratorPage() {
    ...
    const generateKey = () => {
        ...
        // 4. mod - Modelo do Documento Fiscal (2 digits) - 57 para CT-e
        const mod = "57"
        ...
        toast.success("Chave CT-e gerada com sucesso!")
    }
                    ...
                    <div className="grid gap-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Personalize os dados para gerar a chave de acesso CT-e</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <Label>Número do CT-e (Opcional)</Label>
                                        <Input
                                            type="number"
                                            placeholder="Gerado automaticamente se vazio"
                                            value={number}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select value={emissionType} onValueChange={setEmissionType}>
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="8">8 - Contingência SVC-SP</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </div>
                                </div>
                            ...
                            <Card className="bg-muted/50">
                                ...
                                <CardContent>
                                    ...
                                    <div className="mt-4 text-sm text-muted-foreground">
                                        <p><strong>Modelo:</strong> 57 (CT-e)</p>
