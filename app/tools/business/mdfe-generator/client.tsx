...
export function MdfeGeneratorPage() {
    ...
    const generateKey = () => {
        ...
        // 4. mod - Modelo do Documento Fiscal (2 digits) - 58 para MDF-e
        const mod = "58"
        ...
        toast.success("Chave MDF-e gerada com sucesso!")
    }
        ...
        <div className="flex min-h-screen flex-col">
            ...
            <main className="flex-1">
                <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8 max-w-4xl">
                    <Breadcrumbs items={[{ "label": "Ferramentas", "href": "/ferramentas-fiscais" }, { "label": "Dados Empresariais", "href": "/ferramentas-fiscais" }, { "label": "Gerador de MDF-e" }]} className="mb-6" />
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold flex items-center gap-2 mb-2">
                            <FileText className="h-8 w-8 text-primary" />
                            Gerador de Chave MDF-e
                        </h1>
                    ...
                    <div className="grid gap-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Personalize os dados para gerar a chave de acesso MDF-e</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <Label>Número do MDF-e (Opcional)</Label>
                                        <Input
                                            type="number"
                                            placeholder="Gerado automaticamente se vazio"
                                            value={number}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select value={emissionType} onValueChange={setEmissionType}>
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="2">2 - Contingência</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </div>
                                </div>
                            ...
                            <Card className="bg-muted/50">
                                ...
                                <CardContent>
                                    ...
                                    <div className="mt-4 text-sm text-muted-foreground">
                                        <p><strong>Modelo:</strong> 58 (MDF-e)</p>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="pt-4 border-t">
                                ...
                                <div className="flex flex-wrap gap-2 mb-4">
                                    <Link href="/guides/validation/mdfe-generator/python" className="text-xs px-2 py-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200 transition-colors">
                                        Como validar MDF-e em Python
                                    </Link>
                                    <Link href="/guides/validation/mdfe-generator/javascript" className="text-xs px-2 py-1 bg-yellow-100 text-yellow-700 rounded hover:bg-yellow-200 transition-colors">
                                        Como validar MDF-e em JavaScript
                                    </Link>
                                    <Link href="/guides/validation/mdfe-generator/java" className="text-xs px-2 py-1 bg-red-100 text-red-700 rounded hover:bg-red-200 transition-colors">
                                        Como validar MDF-e em Java
                                    </Link>
                                    <Link href="/guides/validation/mdfe-generator/csharp" className="text-xs px-2 py-1 bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors">
                                        Como validar MDF-e em C#
                                    </Link>
                                </div>
