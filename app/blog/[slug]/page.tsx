                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                                ...
                                <ShareButtons
                                    title={post.title}
                                    description={post.description}
                                    url={`https://www.devthru.com/blog/${slug}`}
                                    iconOnly
                                    className="ml-auto"
                                />
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        {relatedPosts.map((related) => (
                                            ...
                                            >
                                                <h4 className="text-sm font-medium group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors line-clamp-2 leading-snug">
                                                    {related.title}
                                                </h4>
