...
DEVTHRU_PAUTAS_POOL = [
    ...
    # --- PAUTAS EXPANDIDAS DE ALTO IMPACTO (FERRAMENTAS TOP DO DEVTHRU) ---
    {
        "slug": "como-validar-formatar-telefone-celular-brasil-ddd",
        "tool_name": "Gerador e Validador de Telefone",
        "tool_url": "https://www.devthru.com/tools/personal/phone",
        "keywords": ["phone", "telefone", "celular", "ddd", "nono digito", "whatsapp", "regex", "brasil"],
        "pauta_title": "Como Validar e Formatar Telefones e Celulares no Brasil com Regex e Nono Dígito",
        "target_keyword": "validar telefone brasil regex, formato telefone celular ddd",
        "meta_title": "Validação de Telefones e Celulares no Brasil com Regex",
        "meta_desc": "Aprenda a validar números de telefone fixo e celular com DDD e nono dígito no Brasil. Padrões Regex e tratamento de máscaras em JavaScript e Python.",
        "focus": "Regras da Anatel para o 9º dígito móvel, tabela de DDDs válidos por estado e máscaras com libphonenumber e regex.",
    },
    {
        "slug": "nfce-vs-nfe-diferencas-xml-consumidor-final",
        "tool_name": "Gerador de NFC-e",
        "tool_url": "https://www.devthru.com/tools/business/nfce-generator",
        "keywords": ["nfce", "nfe", "varejo", "fiscal", "sefaz", "qrcode", "xml", "brasil"],
        "pauta_title": "NFC-e vs NF-e: Principais Diferenças, Estrutura do XML e Regras de Contingência",
        "target_keyword": "nfce vs nfe diferencas, estrutura xml nfce",
        "meta_title": "NFC-e vs NF-e: Entenda as Diferenças e Estrutura XML",
        "meta_desc": "Descubra as diferenças cruciais entre a Nota Fiscal de Consumidor Eletrônica (NFC-e - Modelo 65) e a NF-e (Modelo 55), URLs de consulta e QR Code.",
        "focus": "Modelo 65 vs Modelo 55, geração do QR Code de consulta pública da NFC-e e emissão em contingência offline.",
    },
    {
        "slug": "cte-conhecimento-transporte-eletronico-emissao-xml",
        "tool_name": "Gerador de CT-e",
        "tool_url": "https://www.devthru.com/tools/business/cte-generator",
        "keywords": ["cte", "transporte", "logistica", "fiscal", "sefaz", "xml", "brasil"],
        "pauta_title": "CT-e na Prática: Estrutura do Conhecimento de Transporte Eletrônico e Chave de Acesso",
        "target_keyword": "gerador de cte de teste, estrutura xml cte",
        "meta_title": "Guia Prático do CT-e para Desenvolvedores de Logística",
        "meta_desc": "Entenda como funciona o CT-e (Modelo 57), o cálculo de frete, ICMS de transporte e como montar XMLs de teste para homologação SEFAZ.",
        "focus": "Diferença entre CT-e, CT-e OS e MDF-e, amarração com chaves de NF-e transportadas e validação de schemas SEFAZ.",
    },
    {
        "slug": "linha-digitavel-vs-codigo-barras-boleto-fatores",
        "tool_name": "Validador de Boleto Bancário",
        "tool_url": "https://www.devthru.com/tools/finance/boleto-validator",
        "keywords": ["boleto", "febraban", "banco", "linha digitavel", "codigo de barras", "finance", "brasil"],
        "pauta_title": "Linha Digitável vs Código de Barras de Boleto: Como Funciona o Fator de Vencimento e Moeda",
        "target_keyword": "calcular fator de vencimento boleto, decodificar linha digitavel boleto",
        "meta_title": "Linha Digitável vs Código de Barras: Entenda a Anatomia do Boleto",
        "meta_desc": "Descubra como converter linha digitável em código de barras 2 de 5 intercalado, calcular o fator de vencimento FEBRABAN e validar DVs.",
        "focus": "Especificação FEBRABAN de 44 e 47 dígitos, campo livre bancário e cálculo do novo ciclo de fatores de vencimento pós-2025.",
    },
    {
        "slug": "como-funciona-padrao-rg-estados-novo-cin",
        "tool_name": "Gerador de RG por Estado",
        "tool_url": "https://www.devthru.com/tools/documents/rg",
        "keywords": ["rg", "cin", "carteira identidade", "cpf unico", "documents", "brasil"],
        "pauta_title": "Por que o RG não tem padrão nacional? Da Fragmentação Estadual à Nova CIN (Carteira de Identidade Nacional)",
        "target_keyword": "validar rg por estado, nova carteira identidade nacional cin",
        "meta_title": "A Fragmentação do RG no Brasil e a Chegada da CIN",
        "meta_desc": "Entenda por que cada estado brasileiro calcula o RG de um jeito e como a Carteira de Identidade Nacional (CIN) baseada em CPF unifica o cadastro.",
        "focus": "Algoritmos díspares de validação do RG nos estados (SP, RJ, MG, etc.) e a transição arquitetural para a CIN indexada ao CPF.",
    },
    {
        "slug": "placa-pix-estatica-balcao-como-gerar-imprimir",
        "tool_name": "Gerador de Placa Pix",
        "tool_url": "https://www.devthru.com/tools/finance/placa-pix",
        "keywords": ["pix", "placa pix", "qr code", "comercio", "balcao", "brasil", "design"],
        "pauta_title": "Como Gerar e Imprimir Placas Pix com QR Code Estático em Alta Resolução para Balcão",
        "target_keyword": "gerador de placa pix para imprimir, criar placa pix balcao",
        "meta_title": "Como Criar Placas Pix Profissionais para Balcão",
        "meta_desc": "Aprenda a gerar placas Pix estáticas em PDF/PNG de alta qualidade com QR Code, chave e nome do titular para estabelecimentos comerciais.",
        "focus": "Diferença entre QR Code estático e dinâmico no balcão, boas práticas de resolução para impressão e segurança contra adulteração física.",
    }
]
